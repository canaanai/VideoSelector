...
public class ImageAdapter extends BaseAdapter {
    ...
    public ImageAdapter(Context context, List<Image> imageList, VideoConfig videoConfig) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (type == TYPE_CAMERA) {
            convertView = mLayoutInflater.inflate(R.layout.videoselector_item_camera, parent, false);
            convertView.setTag(null);
        } else if (type == TYPE_NORMAL) {
            ViewHolder holder;
            if (convertView == null) {
                convertView = mLayoutInflater.inflate(R.layout.videoselector_item_image, parent, false);
            ...
            if (mItemSize > 0) {
                ...
                videoConfig.getVideoLoader().displayImage(context, getItem(position).path, holder.photo_image);
